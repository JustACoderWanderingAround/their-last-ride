...
/// <param name="npcText">(Nodes are in sequence) The list of where the node could potentially branch towards based on the option chosen to implement flow and logic (Remember that the first node is 0.)</param>
struct Node
{
	//data
